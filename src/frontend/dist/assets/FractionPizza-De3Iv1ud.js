...
function getFractions(difficulty) {
...
function FractionPizza({ difficulty, onGameOver }) {
  const fractions = getFractions(difficulty);
  const [round, setRound] = reactExports.useState(0);
  const [fIdx, setFIdx] = reactExports.useState(
    () => Math.floor(Math.random() * fractions.length)
  );
  const [shaded, setShaded] = reactExports.useState(/* @__PURE__ */ new Set());
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center p-4 gap-5 pt-6", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: `w-full max-w-sm py-4 rounded-3xl text-center shadow-md transition-colors ${flash === "correct" ? "bg-[#00C9A7]" : "bg-white"}`,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-[#6B6B8A]", children: "Shade" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-black text-6xl text-[#5B4FCF]", children: [
            fraction.num,
            "/",
            fraction.den
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-[#6B6B8A]", children: "of the pizza" })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "svg",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: "Pizza Fraction" }),
            sliceIndices.map((sliceIdx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              PizzaSlice,
              {
                cx,
                cy,
      ...
      flash === "correct" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-6xl", children: "✅" }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[#6B6B8A] font-bold text-sm", children: [
      "Tap slices to shade them • ",
      shaded.size,
      "/",
      fraction.num,
      " selected"
